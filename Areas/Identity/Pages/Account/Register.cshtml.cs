...
namespace etherapist.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = "/Patient/Sessions/Index")
        {
            ...
            Input = new InputModel() {
                RoleList = _roleManager.Roles.Select(role => role.Name).Select(
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    else
                    {
                        ...
                        else if (await _userManager.IsInRoleAsync(loggedInUser, SD.Role_Admin)) {
                            returnUrl = "/Admin/Sessions";
                        }
                        else if (await _userManager.IsInRoleAsync(loggedInUser, SD.Role_Therapist)) {
                            returnUrl = "/Therapist/Sessions";
                        }
