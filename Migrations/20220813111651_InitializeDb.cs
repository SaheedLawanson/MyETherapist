        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MentalCondition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    MeetingSpan = table.Column<TimeSpan>(type: "time", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sessions_AspNetUsers_TherapistId",
                        column: x => x.TherapistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sessions_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sessions_SubscriptionId",
                table: "Sessions",
